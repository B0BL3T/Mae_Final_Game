...
PROBABILITY_BOMB = 0	# probability of each invader dropping a bomb (limited by MAX_BOMBS)
BOMB_SPEED = 10
BOMB_WIDTH =  3
BOMB_HEIGHT = 3
BOMB_COLOR = (0, 0, 255)
